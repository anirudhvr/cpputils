...
typedef void (*void_fn_t2)(void*, void*);
/* { from defs.h */
...
void patricia_process (patricia_tree_t *patricia, void_fn_t2 func);
...
patricia_node_t * try_search_exact2 (patricia_tree_t *tree, char *string);
